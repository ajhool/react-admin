...
function log(type, resource: string, params, response) {
    if (console.group) {
...
export default (data: FakeData, loggingEnabled = false) => {
    ...
    function getResponse(type, resource: string, params) {
        switch (type) {
            case GET_LIST: {
     ...
     */
    return (type, resource: string, params): Promise<any> => {
